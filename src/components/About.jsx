...
const cards = [
  {
    ...
    title: 'Bachelor of BCA [AI/ML]',
    subtitle: 'The Baap Company ,Sangamner',
    details: '2024 - 2027',
  },
  {
    icon: <FaLaptopCode />,
    // title: 'Diploma in Computer Engineering',
    subtitle: 'Sanjivani  College , Kopargaon',
    details: '93.91% | 2020 - 2023',
  },
  {
    icon: <FaSchool />,
    title: 'Board of Secondary Education',
    subtitle: 'Sanjivani Sainiki Jr. College , Kopargaon',
    details: '2022 - 2024',
  },
]
  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        variants={itemVariants}
      >
        I am Ajinkya, a passionate Full-Stack Developer, AI/ML enthusiast, and UI/UX designer. I thrive on building scalable web applications and exploring the latest technologies.
      </motion.p>

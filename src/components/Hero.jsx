...
const roles = ["Full-Stack Developer", "AI/ML Enthusiast", "Python Developer"];
    ...
    >
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-16 max-w-6xl w-full z-10">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-lg">
          ...
          {/* CTA Button - Resume */}
          <motion.a
            href="https://github.com/Ajinkya2441/Portfolio/blob/main/assets/Ajinkya_Pagare_Resume.pdf"

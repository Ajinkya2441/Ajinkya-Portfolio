...
const projects = [
  ...
  {
    title: 'portfolio',
    description: 'Personal portfolio website showcasing projects, skills, and contact information with a modern and responsive design.',
  ...
  {
  title: 'BAAP e-Leave System',
  description: 'An online leave management platform for employees and administrators, featuring application tracking, approval workflows, and leave balance management.',
    technologies: ['HTML', 'CSS', 'Python'],
    image: '/baap-eleave.png',
  ...
  },
  {
    ...
    technologies: ['HTML', 'CSS', 'Python'],
    image: '/weather.png',
    live: 'https://github.com/Ajinkya2441/weather_project',
    github: 'https://github.com/Ajinkya2441/weather_project',
  },

    ...
    <header className="navbar-fixed pt-4">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 relative">
        ...
        <div className="hidden md:flex items-center space-x-4 relative z-10">
          {[
            { href: "https://www.linkedin.com/in/ajinkya-pagare-a05b5b324/", icon: FaLinkedin, label: "LinkedIn" },
            { href: "https://github.com/Ajinkya2441", icon: FaGithub, label: "GitHub" },
            { href: "mailto:pagareajinkya24@gmail.com", icon: FaEnvelope, label: "Email" },
            { href: "https://codolio.com/profile/Ajinkya24", icon: FaCode, label: "Codolio" },
          ].map((social) => (
            <motion.a
              key={social.label}
              href={social.href}
